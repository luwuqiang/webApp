...
scheduler.form_blocks.recurring = {
    ...
    _set_node_value: function(e, t, a) {
        ...
        else if (r.length) for (var n = "object" == typeof a, i = 0; i < r.length; i++)(n || r[i].value == a) && (r[i].checked = n ? !!a[r[i].value] : !!a)
    },
    _init_set_value: function(e, t, a) {
        ...
        function n() {
            ...
            f("dhx_repeat_week").style.display = "none",
            f("dhx_repeat_month").style.display = "none",
            f("dhx_repeat_year").style.display = "none",
            f("dhx_repeat_" + this.value).style.display = "block",
        ...
        function i(e) {
            ...
            a = "no";
                ...
                a = Math.max(1, _(m, "occurences_count"));
                var n = 0;
        ...
        function d(e, t) {
            ...
            if (a.length) {
                ...
                if (r) for (var n = 0; n < a.length; n++) a[n].value == t && (a[n].checked = !0);
                else {
                    var i = 0;
                    switch (t) {
                    case "no":
        ...
        function s(e, t) {
            ...
            case "":
                ...
                break;
            default:
                d(m, "occurences_count"),
                a(m, "occurences_count", r[1])
            }
            a(m, "repeat", e[0]);
        ...
        h = function(e) {
            var t = u(e);
            return scheduler.config.include_end_by && (t = scheduler.date.add(t, 1, "day")),
            t
        },
        ...
        var b = {
            month: function(e, t) {
                ...
                e.push(Math.max(1, a(m, "month_week2"))), scheduler.config.repeat_precise || t.start.setDate(1)),
                t._start = !0
            },
            week: function(e, t) {
                var a = scheduler.form_blocks.recurring._get_node_value;
                e.push(Math.max(1, a(m, "week_count"))),
                e.push(""),
                e.push("");
                for (var r = [], n = a(m, "week_day", !0), i = t.start.getDay(), l = !1, d = 0; d < n.length; d++) r.push(n[d]),
                l = l || n[d] == i;
                r.length || (r.push(i), l = !0),
                r.sort(),
                scheduler.config.repeat_precise ? l || (scheduler.transpose_day_week(t.start, r, 1, 7), t._start = !0) : (t.start = scheduler.date.week_start(t.start), 
                t._start = !0),
                e.push(r.join(","))
            },
            day: function(e) {
            ...
            year: function(e, t) {
                ...
                e.push(a(m, "year_week2")), t.start.setDate(1), t.start.setMonth(a(m, "year_month2"))),
                t._start = !0
            }
        },
        y = {
    ...
    set_value: function(e, t, a) {
        ...
        scheduler._lightbox._rec_init_done || r._init_set_value(e, t, a),
        e.open = !a.rec_type,
        this._is_modified_occurence(a) ? e.blocked = !0: e.blocked = !1;
        var n = r._ds;
        n.start = a.start_date,
        n.end = a._end_date,
        r.button_click(0, e.previousSibling.firstChild.firstChild, e, e),
    ...
    get_value: function(e, t) {
        if (e.open) {
            ...
            r = {};
            this.formSection("time").getValue(r),
            a.start = r.start_date,
            t.rec_type = scheduler.form_blocks.recurring._get_repeat_code(a),
            a._start ? (t.start_date = new Date(a.start), t._start_date = new Date(a.start), a._start = !1) : t._start_date = null,
            t._end_date = a.end,
            t.rec_pattern = t.rec_type.split("#")[0]
        } else t.rec_type = t.rec_pattern = "",
        t._end_date = t.end_date;
        return t.rec_type
    },
    ...
    _toggle_block: function() {
        ...
        a && (a.style.backgroundPosition = "-5px 0px", a.nextSibling.innerHTML = scheduler.locale.labels.button_recurring_open)),
        t.open = !t.open,
        scheduler.setLightboxSize()
    },
    focus: function(e) {},
...
function(e, t) {
    if (!this._ignore_call) {
        this._ignore_call = !0,
        scheduler._rec_markers[e] && (scheduler._rec_markers[t] = scheduler._rec_markers[e], delete scheduler._rec_markers[e]);
...
function(e) {
    ...
    if (this._is_virtual_event(e) || this._is_modified_occurence(t) && t.rec_type && "none" != t.rec_type) {
        ...
        n.id = a,
        n.event_pid = t.event_pid || e[0];
        var i = r;
        n.event_length = i,
        n.rec_type = n.rec_pattern = "none",
        this.addEvent(n),
        this._add_rec_marker(n, 1e3 * i)
    } else {
...
function(e, t) { ! this._is_virtual_event(e) && this._is_modified_occurence(t) && (scheduler._events[e] || (t.rec_type = t.rec_pattern = "none", 
    this.setEvent(e, t)))
}),
...
function(e) {
    ...
    if (this._is_virtual_event(e)) {
        ...
        var n = e[1];
        r.event_length = n,
        r.rec_type = r.rec_pattern = "",
        this._add_rec_marker(r, 1e3 * n),
        this.addEvent(r),
        this._not_render = !1
    } else {
        t.rec_type && this._lightbox_id && this._roll_back_dates(t);
...
scheduler.attachEvent("onEventCancel", 
function(e) {
    var t = this.getEvent(e);
...
scheduler._roll_back_dates = function(e) {
    ...
    e._start_date && (e.start_date.setMonth(0), e.start_date.setDate(e._start_date.getDate()), 
...
scheduler.showLightbox = function(e) {
    ...
    var l = function(e) {
        ...
        return t._end_date = t.end_date,
        t.end_date = new Date(t.start_date.valueOf() + 1e3 * t.event_length),
        scheduler.showLightbox_rec(e)
    };
...
function() {
    ...
    scheduler.updateEvent = function(e) {
        ...
        a && a.rec_type && (a.rec_pattern = (a.rec_type || "").split("#")[0]),
        a && a.rec_type && !this._is_virtual_event(e) ? scheduler.update_view() : t.call(this, e)
    }
} (),
...
scheduler.transpose_day_week = function(e, t, a, r, n) {
    for (var i = (e.getDay() || (scheduler.config.start_on_monday ? 7: 0)) - a, l = 0; l < t.length; l++) if (t[l] > i) return e.setDate(e.getDate() + 1 * t[l] - i - (r ? a: n));
    ...
    if (!this.date[t]) {
        ...
        if ("day" == a[0] || "week" == a[0]) {
            ...
            this.date[t] = function(e, t) {
                ...
                a > 0 && e.setDate(e.getDate() + a * i),
                l && scheduler.transpose_day_week(e, l, 1, i)
            },
            this.date[n] = function(e, t) {
                var a = new Date(e.valueOf());
                if (l) for (var r = 0; t > r; r++) scheduler.transpose_day_week(a, l, 0, i);
            ...
            r >= 0 && e.setMonth(e.getMonth() + r * i),
            a[3] && scheduler.date.day_week(e, a[2], a[3]);


        },
        this.date[n] = function(e, t) {
            var r = new Date(e.valueOf());
            return r.setMonth(r.getMonth() + t * i),
            a[3] && scheduler.date.day_week(r, a[2], a[3]),
            r
        })
    }
},
scheduler.repeat_date = function(e, t, a, r, n) {
    ...
    for (; n > i && i < e.end_date;) {
        ...
        if (d) a && t.push(d);
            ...
            t.push(o),
            a || (this._events[o.id] = o, this._rec_temp.push(o))
        }
...
scheduler.getRecDates = function(e, t) {
    ...
    for (; i < a.end_date;) {
        ...
        if (d)"none" == d.rec_type ? s = !1: n.push({
            ...
            _ = scheduler._fix_daylight_saving_date(o, _, a, i, _),
            n.push({
                start_date: o,
                end_date: _
            })
