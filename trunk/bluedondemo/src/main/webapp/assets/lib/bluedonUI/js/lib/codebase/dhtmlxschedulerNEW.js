...
-1 != navigator.userAgent.indexOf("Safari") || -1 != navigator.userAgent.indexOf("Konqueror") ? (_KHTMLrv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Safari") + 7, 5)), _KHTMLrv > 525 ? (_isFF = !0, _FFrv = 1.9) : _isKHTML = !0) : -1 != navigator.userAgent.indexOf("Opera") ? (_isOpera = !0, _OperaRv = parseFloat(navigator.userAgent.substr(navigator.userAgent.indexOf("Opera") + 6, 3))) : -1 != navigator.appName.indexOf("Microsoft") ? (_isIE = !0, 
-1 == navigator.appVersion.indexOf("MSIE 8.0") && -1 == navigator.appVersion.indexOf("MSIE 9.0") && -1 == navigator.appVersion.indexOf("MSIE 10.0") || "BackCompat" == document.compatMode || (_isIE = 8)) : "Netscape" == navigator.appName && -1 != navigator.userAgent.indexOf("Trident") ? _isIE = 8: (_isFF = !0, _FFrv = parseFloat(navigator.userAgent.split("rv:")[1])),
...
dataProcessor.prototype = {
    ...
    setUpdated: function(e, t, i) {
        if (!this._silent_mode) {
            ...
            a && "updated" == i && (i = a),
            t ? (this.set_invalid(e, !1), this.updatedRows[s] = e, this.obj.setUserData(e, this.action_param, i), this._in_progress[e] && (this._in_progress[e] = "wait")) : this.is_invalid(e) || (this.updatedRows.splice(s, 1), 
    ...
    _getAllData: function(e) {
        for (var t = {},
        i = !1, s = 0; s < this.updatedRows.length; s++) {
...
scheduler._on_mouse_move = function(e) {
    if (this._drag_mode) {
        ...
        if (t.force_redraw || this._is_pos_changed(this._drag_pos, t)) {
            ...
            if ("move" == this._drag_mode) i = this._min_date.valueOf() + 6e4 * (t.y * this.config.time_step + 24 * t.x * 60 - (scheduler._move_pos_shift || 0)),
            !t.custom && this._table_view && (i += 1e3 * this.date.time_part(o.start_date)),
            i = this._correct_shift(i),
            t._ignores && this.config.preserve_length && this._table_view ? (this.matrix && (d = this.matrix[this._mode]), d = d || {
                x_step: 1,
                x_unit: "day"
            },
            s = 1 * i + this._get_fictional_event_length(i, this._drag_event._event_length, d)) : s = o.end_date.valueOf() - (o.start_date.valueOf() - i);
                ...
                } else s = this.date.date_part(new Date(o.end_date.valueOf() - 1)).valueOf() + t.y * this.config.time_step * 6e4,
...
scheduler._calc_scale_sizes = function(e, t, i) {
    ...
    for (var n = a - this._ignores_detected, r = 0; a > r; r++) this._ignores[r] ? (this._cols[r] = 0, n++) : this._cols[r] = Math.floor(s / (n - r)),
    s -= this._cols[r],
...
scheduler._render_month_scale = function(e, t, i) {
    ...
    for (var _ = 0, c = "<table cellpadding='0' cellspacing='0'>", u = [], l = 0; d > l; l++) {
        ...
        for (var g = Math.max(s(l) - scheduler.xy.month_head_height, 0), f = 0; 7 > f; f++) {
            ...
            p = "dhx_month_head";
            0 === f && this.config.left_border && (m += " dhx_month_body_border", p += " dhx_month_head_border"),
            this._ignores_detected && this._ignores[f] ? c += "<div></div><div></div>": (c += "<div class='" + p + "'>" + this.templates.month_day(i) + "</div>", c += "<div class='" + m + "' " + o[f] + ";height:" + g + "px;'></div></td>"),
            u.push(i);
            var x = i.getDate();
...
scheduler.date = {
    init: function() {
        for (var e = scheduler.locale.date.month_short, t = scheduler.locale.date.month_short_hash = {},
        i = 0; i < e.length; i++) t[e[i]] = i;
        for (var e = scheduler.locale.date.month_full, t = scheduler.locale.date.month_full_hash = {},
        i = 0; i < e.length; i++) t[e[i]] = i
    },
...
scheduler.locale = {
    ...
    labels: {
        ...
        icon_delete: "删除",
        confirm_closing: "",
        confirm_deleting: "你确定要永久删除这条信息吗?",
        section_description: "详细",
        section_time: "时间",
        full_day: "Full day",
...
scheduler._render_v_bar = function(e, t, i, s, a, n, r, d, o) {
    ...
    m += '<div class="dhx_body" style=" width:' + (s - (this._quirks ? 4: 14)) + "px; height:39px;" + u + g + '">' + d + "</div>";
...
scheduler.showEvent = function(e, t) {
    ...
    if (t = t || scheduler._mode, i && (!this.checkEvent("onBeforeEventDisplay") || this.callEvent("onBeforeEventDisplay", [i, t]))) {
        ...
        var n = i.color,
        r = i.textColor;
        scheduler.config.highlight_displayed_event && (i.color = scheduler.config.displayed_event_color, i.textColor = scheduler.config.displayed_event_text_color),
    ...
    this.getLightbox().onclick = function(e) {
        ...
        default:
            if (t.getAttribute("dhx_button")) scheduler.callEvent("onLightboxButton", [t.className, t, e]);
                ...
                var s,
                a,
                n; - 1 != t.className.indexOf("dhx_custom_button") && ( - 1 != t.className.indexOf("dhx_custom_button_") ? (s = t.parentNode.getAttribute("index"), n = t.parentNode.parentNode) : (s = t.getAttribute("index"), n = t.parentNode, t = t.firstChild)),
...
scheduler._lightbox_template = "<div class='dhx_cal_ltitle'><span class='dhx_mark'>&nbsp;上课时间：</span><span class='dhx_time'></span><span class='dhx_title'></span></div><div class='dhx_cal_larea'></div>",
...
scheduler._touch_events = function(e, t, i) {
    ...
    s(this._els.dhx_cal_data[0], e[1], 
    function(e) {
        if (!i(e)) {
            var s;
        ...
        if ("string" != typeof i) {
            ...
            return this.each(function() {
                if (this && this.getAttribute && !this.getAttribute("dhxscheduler")) {
                    ...
                    this.getElementsByTagName("div").length || (this.innerHTML = '<div class="dhx_cal_navline"><div class="dhx_cal_prev_button">&nbsp;</div><div class="dhx_cal_next_button">&nbsp;</div><div class="dhx_cal_today_button"></div><div class="dhx_cal_date"></div><div class="dhx_cal_tab" name="day_tab" style="right:204px;"></div><div class="dhx_cal_tab" name="week_tab" style="right:140px;"></div><div class="dhx_cal_tab" name="month_tab" style="right:76px;"></div></div><div class="dhx_cal_header" style="height:35px; line-height:35px; background:#f0f7fd; color:#555;"></div><div class="dhx_cal_data"></div>', 
