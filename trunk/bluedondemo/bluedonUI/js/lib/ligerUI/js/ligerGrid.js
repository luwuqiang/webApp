...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
		...
		_delHdcheck:function()//luoxiaohong add
		{
			var _row = $(".l-grid-row").length/2;
			var _selectrow = $(".l-selected").length/2;
			if(_selectrow<_row){
        ...
        _getHtmlFromData: function (data, frozen)
        {
            ...
            for (var i = 0, l = data.length; i < l; i++)
            {
                ...
                $(g.columns).each(function (columnindex, column)
                {
                    ...
                    gridhtmlarr.push('<td valign="middle"');
                    ...
                    if (this.ischeckbox)
                    {
                        ...
                        if (p.fixedCellHeight)
                            ...
                            gridhtmlarr.push(' style = "min-height:' + p.rowHeight + 'px;" ');
                        gridhtmlarr.push('>');
                        gridhtmlarr.push('<span class="l-grid-row-cell-btn-checkbox" rowid ="'+g.rowindex+'"></span>');
        ...
        _onClick: function (e)
        {
            ...
            else if (src.row && g.enabledCheckbox()) //复选框选择行
            {
                ...
                if (src.checkbox || !selectRowButtonOnly)
                {
					...
					/*luoxiaohong*/
					var _nrow = $(".l-grid-row").length;
					var _nselectrow;
					$(".l-selected").each(function(){
						_nselectrow = $(".l-selected").length;
						if(_nselectrow<_nrow){
							$(".l-grid-hd-row").removeClass("l-checked");
						}else{
							$(".l-grid-hd-row").addClass("l-checked");
						}
