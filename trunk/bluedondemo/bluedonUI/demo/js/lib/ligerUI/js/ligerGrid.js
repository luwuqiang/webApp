                ...
                p.detail = {
                    ...
                    onShowDetail: function (record, container, callback)
                    {
                        ...
                        g.beginEdit(record, function (rowdata, column)
                        {
                            ...
                            editContainer.width(120).height(22);
...
//                        $("<div class='l-button'>" + p.applyMessage + "</div>").appendTo(container).click(function ()//编辑内的应用
//                        {
//                            g.submitEdit(record);
//                        });
                        $("<div class='l-button' style='background-color:#ececec;border:1px solid #e0e0e0;color:#666'>" + p.cancelMessage + "</div>").appendTo(container).click(function ()
                        {
                            g.cancelEdit(record);
                            removeRow();
                        });
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                          <div class='l-grid-header-inner' style='width:100%'><table class='l-grid-header-table' cellpadding='0' cellspacing='0'><tbody></tbody></table></div>");
        ...
        */
        ...
        _fillGridBody: function (data, frozen)
        {
            var g = this, p = this.options;
            //加载数据 
            var gridhtmlarr = ['<div class="l-grid-body-inner" style="width:100%"><table class="l-grid-body-table" cellpadding=0 cellspacing=0 style="width:100%"><tbody>'];
